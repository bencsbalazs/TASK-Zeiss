[![Python application](https://github.com/bencsbalazs/TASK-Zeiss/actions/workflows/python-app.yml/badge.svg)](https://github.com/bencsbalazs/TASK-Zeiss/actions/workflows/python-app.yml)
